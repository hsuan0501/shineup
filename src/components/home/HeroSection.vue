<template>
    <section class="relative flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 w-full pt-24 pb-8 overflow-hidden">
        ...
        <div class="relative flex flex-col items-center justify-center text-center z-10 max-w-5xl mx-auto w-full mb-16">
            ...
            <!-- Left Side (3 stars) -->
            <div class="absolute -top-12 left-[23%] w-3.5 h-3.5 animate-twinkle-2 text-white scale-y-[-1]">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 0L14 10L24 12L14 14L12 24L10 14L0 12L10 10Z" />
                </svg>
            </div>
            <div class="absolute top-2 left-[19%] w-2.5 h-2.5 animate-twinkle-4 text-white scale-y-[-1]">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 0L14 10L24 12L14 14L12 24L10 14L0 12L10 10Z" />
                </svg>
            </div>
            ...
            <!-- Right Side (2 stars) -->
            <div class="absolute -top-12 right-[26%] w-3.5 h-3.5 animate-twinkle-2 text-white">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 0L14 10L24 12L14 14L12 24L10 14L0 12L10 10Z" />
                </svg>
            </div>
            <div class="absolute top-0 right-[21%] w-2.5 h-2.5 animate-twinkle-4 text-white">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 0L14 10L24 12L14 14L12 24L10 14L0 12L10 10Z" />
                </svg>
            </div>
            ...
            <!-- Top Center -->
            <div class="absolute -top-14 left-[38%] w-1.5 h-1.5 animate-twinkle-3 text-white">
                <svg viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 0L14 10L24 12L14 14L12 24L10 14L0 12L10 10Z" />
                </svg>
            </div>
