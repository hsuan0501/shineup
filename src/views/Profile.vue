    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
      ...
      <div class="lg:col-span-3 space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
          ...
          <!-- 當前等級權益 -->
          <div class="bg-gradient-to-r from-sky-50 to-indigo-50 dark:from-sky-900/20 dark:to-indigo-900/20 rounded-xl p-4 mb-4">
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center gap-2">
                ...
                <span class="text-sm text-gray-700 dark:text-gray-300">可兌換<span v-if="user.level === 'EXPLORER'">「永續探索」</span><span v-else-if="user.level === 'CREATOR'">「質感創造」</span><span v-else-if="user.level === 'VISIONARY'">「美學先鋒」</span><span v-else-if="user.level === 'LUMINARY'">「品味閃耀」</span>系列禮品</span>
              </div>
            </div>
          </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
          ...
          <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div class="text-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
              ...
              <div class="text-xl font-bold text-blue-600 dark:text-blue-400 mb-1">{{ user.stats?.tasksCompleted || 0 }}</div>
            ...
            <div class="text-center p-3 bg-green-50 dark:bg-green-900/20 rounded-xl">
              ...
              <div class="text-xl font-bold text-green-600 dark:text-green-400 mb-1">{{ user.stats?.totalLogins || 0 }}</div>
            ...
            <div class="text-center p-3 bg-purple-50 dark:bg-purple-900/20 rounded-xl">
              ...
              <div class="text-xl font-bold text-purple-600 dark:text-purple-400 mb-1">{{ user.stats?.rewardsRedeemed || 0 }}</div>
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="text-xs text-gray-500 dark:text-gray-400 leading-relaxed space-y-1">
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <span>可兌換對應等級系列禮品<span v-if="levelInfo.level === 'EXPLORER'">「永續探索」</span><span v-else-if="levelInfo.level === 'CREATOR'">「質感創造」</span><span v-else-if="levelInfo.level === 'VISIONARY'">「美學先鋒」</span><span v-else-if="levelInfo.level === 'LUMINARY'">「品味閃耀」</span>系列</span>
                    </div>
                  </div>
                </div>
              </div>
