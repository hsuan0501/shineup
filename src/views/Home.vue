<template>
    <div class="w-full" id="home-top">
        ...
        <button @click="scrollToTop" v-show="showScrollTop"
            ...
            aria-label="回到頂部">
            <svg class="w-5 h-5 text-gray-600 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white transition-colors duration-300"
        ...
        <!-- Hero Section -->
        <section
            class="relative min-h-screen flex flex-col items-center justify-start px-4 sm:px-6 lg:px-8 w-full pt-24">
        ...
        <section class="w-full pt-20 pb-8 px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto">
                ...
                <div id="tasks" class="flex gap-4 mb-4 overflow-x-auto pb-2 justify-center"
                    ...
                    <button v-for="cat in taskCategories" :key="cat.id" @click="selectTaskCategory(cat.id)"
                        type="button" :class="[
                        ...
                        <div class="p-2 relative">
                            ...
                            <div class="flex items-center justify-between mb-1.5">
                                <div class="flex items-baseline gap-1">
                                    ...
                                    <span
                                        class="text-xs text-light-text-secondary dark:text-dark-text-secondary">積分</span>
                                </div>
