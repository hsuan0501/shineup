<template>
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div v-if="cartItems.length > 0" class="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start">
            <!-- 購物車商品列表 -->
            <div class="lg:col-span-3 bg-white dark:bg-gray-800/50 rounded-2xl p-6 dark:backdrop-blur-xl border dark:border-gray-600/30 h-[600px] overflow-hidden flex flex-col hover:scale-[1.01] transition-transform duration-300">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6">購物車商品</h2>
                <div class="flex-1 overflow-y-auto space-y-4 pr-2 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent">
                    <div v-for="item in cartItems" :key="item.id"
                        class="group relative overflow-hidden bg-white dark:bg-gray-700/70 dark:backdrop-blur-xl rounded-2xl p-6 dark:shadow-2xl border dark:border-gray-600/30 transition-transform duration-300 hover:scale-[1.02] cursor-pointer">
            ...
            <div class="lg:col-span-2">
                <div class="sticky top-24 bg-white dark:bg-gray-700/70 dark:backdrop-blur-xl rounded-2xl p-6 dark:shadow-2xl border dark:border-gray-600/30 hover:scale-[1.01] transition-transform duration-300 h-[600px] flex flex-col">
